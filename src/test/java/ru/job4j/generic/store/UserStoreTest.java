...
class UserStoreTest {
    ...
    void whenAddAndFindThenUsernameIsPetr() {
        ...
        Assertions.assertThat(result.getUsername()).isEqualTo("Petr");
    }
    ...
    void whenReplaceThenUsernameIsMaxim() {
        ...
        User result = store.findById("1");
        Assertions.assertThat(result.getUsername()).isEqualTo("Maxim");
    }
    ...
    void whenReplaceOkThenTrue() {
        ...
        Assertions.assertThat(rsl).isTrue();
    }
    ...
    void whenReplaceNotOkThenFalse() {
        ...
        Assertions.assertThat(rsl).isFalse();
    }
